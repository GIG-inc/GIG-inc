...
const file_proto_gateway_proto_rawDesc = "" +
	...
	"\aamounts\x12\x16\n" +
	"\x06amount\x18\x01 \x01(\x03R\x06amount2\xa0\x02\n" +
	"\n" +
	"gigservice\x12:\n" +
	"\x0faccount_details\x12\x16.user_account_data_req\x1a\x0f.user_data_resp\x12-\n" +
	"\btransfer\x12\r.transfer_req\x1a\x0e.transfer_resp(\x010\x01\x12\x1d\n" +
...
var file_proto_gateway_proto_depIdxs = []int32{
	...
	5,  // 18: gigservice.account_details:input_type -> user_account_data_req
	6,  // 19: gigservice.transfer:input_type -> transfer_req
	7,  // 20: gigservice.sale:input_type -> sale_req
	9,  // 21: gigservice.history:input_type -> history_req
	9,  // 22: gigservice.opening:input_type -> history_req
	0,  // 23: gigservice.createaccount:input_type -> create_user_req
	10, // 24: gigservice.account_details:output_type -> user_data_resp
	12, // 25: gigservice.transfer:output_type -> transfer_resp
	11, // 26: gigservice.sale:output_type -> sale_resp
	14, // 27: gigservice.history:output_type -> history_resp
	14, // 28: gigservice.opening:output_type -> history_resp
	2,  // 29: gigservice.createaccount:output_type -> create_user_resp
